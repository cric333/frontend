...
export default function CricketApp() {
  ...
  useEffect(() => {
    const fetchData1 = () => {
      fetch(`${baseUrl}/api/cricket/data1`)
        .then(res => res.json())
    ...
    const fetchData2 = () => {
      fetch(`${baseUrl}/api/cricket/data2`)
        .then(res => res.json())
    ...
    const fetchData3 = () => {
      fetch(`${baseUrl}/api/cricket/data3`)
        .then(res => res.json())
    ...
    const fetchData4 = () => {
      fetch(`${baseUrl}/api/cricket/data4`)
        .then(res => res.json())
    ...
    const fetchData5 = () => {
      fetch(`${baseUrl}/api/cricket/data5`)
        .then(res => res.json())
    ...
    const fetchProfile1 = () => {
      fetch(`${baseUrl}/api/cricket/profile1`)
        .then(res => res.json())
    ...
    const fetchProfile2 = () => {
      fetch(`${baseUrl}/api/cricket/profile2`)
        .then(res => res.json())
    ...
    const fetchProfile3 = () => {
      fetch(`${baseUrl}/api/cricket/profile3`)
        .then(res => res.json())
    ...
    const fetchProfile4 = () => {
      fetch(`${baseUrl}/api/cricket/profile4`)
        .then(res => res.json())
    ...
    const fetchProfile5 = () => {
      fetch(`${baseUrl}/api/cricket/profile5`)
        .then(res => res.json())
